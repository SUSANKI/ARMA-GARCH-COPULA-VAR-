---
title: "GARCH-EVT-COPULA APPROACH (FINAL 2)"
...
layout(matrix(c(1),1,1))
plot(cbind(real_port_return,VaR99_return_G,VaR95_return_G,VaR90_return_G),col=c("black","deeppink3","darkorange2","blue"),main="GAUSSIAN COPULA",lwd=1)
```
...
# VaR 99%
plot(plot(cbind(real_port_return,VaR99_return_G,VaR99_return_T,VaR99_return_C,VaR99_return_Gum,VaR99_return_F),col=c("black","blue","pink","darkorange2","red","darkmagenta"),main="VAR 99%",lwd=1))
